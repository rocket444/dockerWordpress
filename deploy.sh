...
docker exec -ti wp-deploy_db_1 /usr/bin/mysqldump -u wordpress -wordpress -d wordpress > dump.sql

# zip-file mit user-generated data -> /wp-content/uploads
tar -C ./wp/wp-content/ -cvzf uploads.tar.gz ./uploads

# zip-file mit themes -> /wp-content/themes
tar -C -/wp/wp-content/ -cvzf themes.tar.gz ./themes

# zip-file mit plugins -> /wp-content/plugins
tar -C ./wp/wp-content/ -cvzf plugins.tar.gz ./plugins
